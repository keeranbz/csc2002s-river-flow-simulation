...
/**
 * View
 * Main display window that shows the landscape as a greyscale image, 
 * with black representing the lowest elevation and white the highest. 
 * Overlaid on the terrain is an image representing the locations of water in blue.
 **/
public class Flow {
   ...
   public static float getTime(){
	...
	public static void setupGUI(int frameX,int frameY, Terrain landdata, Water water) {
      ...
      /* A counter that displays the number of timesteps since 
      ...
      /* Reset button that zeroes both the water depth across the 
         entire landscape and the timestep count. */
      ...
      /* Play button that starts the simulation and allows it to 
         continue running if previously paused. */
